  ...
  /*  @Autowired
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
        ...
        if (userId == 1) {
            ...
            Object templateTypeId =  session.getAttribute(Global.TEMPLATE_TYPE_ID);
            if(templateTypeId != null){
                permsList = sysUserDao.queryAllPerms(userId,Long.valueOf(templateTypeId.toString()));
            }else{
                permsList = sysUserDao.queryAllPerms(userId, -1L);
            }
        }
